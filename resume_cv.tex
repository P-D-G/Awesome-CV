...
%\name{Philip-Dylan}{Gleonec}
%\position{Ingénieur R\&D{\enskip\cdotp\enskip}Spécialisé en systèmes embarqués}
%\address{172 Rue de Fougères Apt.103, 35700 Rennes, France}

%\mobile{(+33) 06 31 61 87 47}
%\email{philip-dylan@gleonec.bzh}
%\homepage{https://www.linkedin.com/in/pdg/}
%\github{posquit0}
%\linkedin{posquit0}
%\skype{skypeid}
...
%\makecvfooter{}{Philip-Dylan Gleonec~~~·~~~Résumé}{\thepage} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed

\input{cv-sections/info.tex}

\makecvfooter{}{John Doe~~~·~~~Resume}{\thepage} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
